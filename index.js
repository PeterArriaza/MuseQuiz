...
function renderResults () {
  if (score >= 5) {
    $('.questionAnswerForm').html(`<div class="results correctFeedback"><h3>Wicked mate!</h3><img src="https://media.tenor.com/images/6025a156693a0d29acf23bbb61bb88fc/tenor.gif" alt="Matt Bellamy thumbs up"/><p>You got ${score} / 7!</p><p>You sure know a lot about Muse!</p><button class="restartButton">Restart Quiz</button></div>`);
  } else if (score < 5 && score >= 2) {
    $('.questionAnswerForm').html(`<div class="results correctFeedback"><h3>Groovy!</h3><img src="https://media2.giphy.com/media/Ep8kUCWzqNOJq/giphy.gif?cid=3640f6095bc3b48354587248418047d5" alt="Matt Bellamy thumbs up"/><p>You got ${score} / 7.</p><button class="restartButton">Restart Quiz</button></div>`);
  } else {
